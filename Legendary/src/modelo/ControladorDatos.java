...
public interface ControladorDatos {
	...
	/**
	 * Este metodo lo usamos para conseguir una lista de los usuarios de la base de datos
	 * 
	...
	/**
	 * Este metodo lo usamos para modificar los datos de el hardware de nuestra base de datos
	 * @param har
	 */
	...
	/**
	 * 
	 * Este metodo lo usamos para listar los datos de Hardware de nuestra base de datos
	 * @param tipo
	...
	/**
	 * Este metodo lo usamos para lista el tipo de juego de los torneos de la base de datos
	 * @return {@code ArrayList<Torneo>}
	 */
